...
//!
//! ## 存储位置
//! - Windows: %USERPROFILE%\.claude-workbench\mcp-registry.json
//! - macOS/Linux: ~/.claude-workbench/mcp-registry.json
//!
//! ## 数据结构
//! ```json
//! {
...
fn registry_path() -> PathBuf {
    ...
    home_dir.join(".claude-workbench").join("mcp-registry.json")
}
